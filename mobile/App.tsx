...
import { StyleSheet, View, StatusBar, Alert, Keyboard, Platform } from 'react-native';
...
const addLocation = (location: Omit<SavedLocation, 'id'>) => {
  ...
  const renderPage = () => {
    return (
      <>
        {/* Chat Page - Always mounted but hidden when not active to preserve state */}
        <View 
          style={[
        ...
        >
          <ChatBoxPage onTasksUpdate={async () => {
            const cloudTasks = await TaskManager.syncWithCloud();
            setTasks(cloudTasks);
          }} />
        </View>

        {/* Other Pages - Mounted only when active */}
        {currentPage === 'home' && (
        ...
        {currentPage === 'settings' && (
          <View style={styles.pageContainer}>
            <SettingsPage onSync={syncWithServer} />
          </View>
        )}
      </>
    );
    ...
    <SafeAreaProvider>
      ...
      >
        <SafeAreaView style={styles.safeArea} edges={['top', 'left', 'right']}>
          ...
          {/* Page content */}
          <View style={[styles.content, { paddingBottom: isKeyboardVisible ? 0 : 80 }]}>
            {renderPage()}
          </View>
